...
@section('content')
    <div class="container">
        <div class="display-2">Add New Product</div>
        <hr>
    ...
    <div class="card bg-shadow-sm mb-4">
        <div class="text-center">
            <div class="mt-2 mb-2">
                <div class="mb-2">Add New Selection, Category / Brands / Variation</div>
                <a class="btn btn-sm btn-outline-primary col-3" href="{{ route('categories.create') }}">Add a Category</a>
                <a class="btn btn-sm btn-outline-primary col-3" href="{{ route('brands.create') }}">Add a Brand</a>
                <a class="btn btn-sm btn-outline-primary col-3" href="{{ route('variation.create') }}">Add a Variation</a>
            </div>
        </div>
    </div>
</div>
